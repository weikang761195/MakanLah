...
//        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        //for facebook logged in


        // for google logged in, Result returned from launching the Intent from GoogleSignInApi.getSignInIntent(...);
        if (requestCode == 101) {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(getApplicationContext(),"User logged in fail", Toast.LENGTH_SHORT).show();
                        }
...
//    }
    ...
    public void login(View v){
        Log.d("User clicked", "login: progress");
